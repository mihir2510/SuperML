...
stats,model = auto_train(dataset, label, 'prediction', models=models, modelClass='RandomForestRegressor', hpo_methods=['standard'],sortby='r2',download_model='tester',excel_file='excel_file')#,'grid_search','random_search', 'bayesian_tpe'],sortby='r2')#])
