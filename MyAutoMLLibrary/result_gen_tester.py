...
stats,model = auto_train(dataset, label, 'classification', models=models, modelClass='RandomForestClassifier', hpo_methods=['standard'],download_model='tester',excel_file='excel_file')#,'grid_search','random_search', 'bayesian_tpe'],sortby='r2')#])
