...
model,stats,f =automl_run(dataset, label,base_layer_models=['LogisticRegression'], meta_layer_models=['LogisticRegression'], task='classification',excel_file='1',sortby='accuracy')
print(f)
...
#stats,model= auto_trainer(dataset,label,task='classification',feature_engineering_methods= ['pca'], hpo_methods=['standard'], models=[] ,anova_estimator=None, sortby='f1',excel_file='1',max_evals=100)
